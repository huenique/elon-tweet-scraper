...
class TwitterException(Exception):
    ...
    """
    def __init__(self, *args: object, headers: dict | None = ...) -> None: ...
...
class TooManyRequests(TwitterException):
    ...
    """
    def __init__(self, *args, headers: dict | None = ...) -> None: ...
...
def raise_exceptions_from_response(errors: list[dict]):  # -> None:
    ...
