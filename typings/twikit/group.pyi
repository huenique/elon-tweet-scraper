...
class Group:
    ...
    async def get_history(self, max_id: str | None = ...) -> Result[GroupMessage]:
        """
    ...
    async def send_message(
        self, text: str, media_id: str | None = ..., reply_to: str | None = ...
    ) -> GroupMessage:
        """
...
class GroupMessage(Message):
    ...
    async def reply(self, text: str, media_id: str | None = ...) -> GroupMessage:
